      ...
      <div className="scroll">
        <div className="head">
          ...
          <div style={{ display: 'flex', gap: 2, alignItems: 'center' }}>
            ...
            <span className="head-sub" style={{ minWidth: '9ch', textAlign: 'center' }}>
              {formatMonth(month)}
            </span>
            <button
              type="button"
        ...
        <div className="card pad" style={{ marginBottom: 12 }}>
          ...
          <div
            className="big-money"
            style={{ color: summary.balanceCents < 0 ? 'var(--bad)' : 'var(--text)' }}
          >
        ...
        <div className="btn-row" style={{ marginTop: 0 }}>
          <button type="button" className="btn btn-primary" onClick={() => setCompose('ausgabe')}>
            <IconPlus size={18} />
            Ausgabe
          </button>
  ...
  return (
    ...
    >
      <div className="segmented" style={{ marginBottom: 16 }}>
        <button type="button" aria-pressed={txKind === 'ausgabe'} onClick={() => setTxKind('ausgabe')}>
          Ausgabe
        </button>
        <button type="button" aria-pressed={txKind === 'einnahme'} onClick={() => setTxKind('einnahme')}>
          Einnahme
        </button>
      </div>
